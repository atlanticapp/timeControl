...
<head>
    ...
    <link rel="stylesheet" href="/timeControl/public/assets/css/qa/destinos/retrabajo.css">
</head>
                    ...
                    <div class="logo-container">
                        ...
                        <div>
                            <nav class="breadcrumb-modern mb-2" aria-label="Breadcrumb">
                                ...
                                <i class="fas fa-chevron-right text-xs"></i>
                                <span>Destinos de Retrabajo</span>
                            </nav>
                            <h1 class="text-2xl md:text-3xl font-bold text-white flex items-center gap-3">
                                <i class="fas fa-recycle"></i>
                                Destinos de Retrabajo
                            </h1>
                            <p class="text-white/80 mt-1 text-sm">Control de Destinos para Material Retenido - Retrabajo</p>
                        </div>
                    </div>
            ...
            <div class="modern-card overflow-hidden">
                <div class="p-5 modal-header">
                    <h3 class="text-lg font-bold text-white flex items-center">
                        <i class="fas fa-clipboard-list mr-3"></i>Listado de Destinos - Retrabajo
                    </h3>
                ...
                <?php if (empty($data['destinos'] ?? [])): ?>
                    <div class="text-center py-12 text-gray-500 fade-in">
                        <i class="fas fa-recycle text-6xl mb-4" style="color: var(--primary-blue);"></i>
                                    ...
                                    <tbody>
                                        <?php foreach ($destinos as $destino): ?>
                                            <tr class="destino-row fade-in"
                                                ...
                                                <div class="px-4 py-3 text-right font-bold">
