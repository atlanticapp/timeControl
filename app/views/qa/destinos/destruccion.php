    ...
    <main class="lg:ml-72 p-6 md:p-8 transition-all duration-300 min-h-screen bg-gray-50">
        <div class="container mx-auto pt-14 lg:pt-4">
                ...
                <div class="p-5">
                    <div class="flex flex-col md:flex-row md:justify-between md:items-center">
                        <div class="mb-4 md:mb-0">
                            <h1 class="text-2xl font-bold text-red-700 flex items-center">
                                <i class="fas fa-trash-alt mr-3"></i>Destinos de Destrucción
                            </h1>
                            <p class="text-gray-500 mt-1">Control de Destinos para Material Retenido - Destrucción</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                <div class="bg-gradient-to-r from-red-500 to-red-600 text-white px-6 py-4 flex justify-between items-center">
                    <h3 class="text-lg font-bold flex items-center">
                        <i class="fas fa-list-alt mr-3"></i>Listado de Destinos - Destrucción
                    </h3>
                                ...
                                <?php foreach ($data['destinos'] as $destino): ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3 font-bold text-red-600">
                                            <?= number_format($destino['cantidad'], 2) ?> 
                                            <span class="text-xs text-gray-500">lb.</span>
                                        </td>
