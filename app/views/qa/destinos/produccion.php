                    ...
                    <div class="flex flex-col md:flex-row md:justify-between md:items-center">
                        <div class="mb-4 md:mb-0">
                            <h1 class="text-2xl font-bold text-blue-700 flex items-center">
                                <i class="fas fa-box-open mr-3"></i>Destinos de Producción
                            </h1>
                            <p class="text-gray-500 mt-1">Control de Destinos para Material Retenido - Producción</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <?php foreach ($data['destinos'] as $destino): ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-3"><?= htmlspecialchars($destino['nombre_maquina']) ?></td>
