...
<head>
    ...
    <meta name="description" content="Sistema de Control de Calidad - Destinos de Producción">
    <title>Control de Calidad - Destinos de Producción</title>
    ...
    <link rel="stylesheet" href="/timeControl/public/assets/css/qa/destinos/produccion.css">
                    ...
                    <div class="logo-container">
                        ...
                        <div>
                            <nav class="breadcrumb-modern mb-2" aria-label="Breadcrumb">
                                ...
                                <i class="fas fa-chevron-right text-xs"></i>
                                <span>Destinos de Producción</span>
                            </nav>
                            <h1 class="text-2xl md:text-3xl font-bold text-white flex items-center gap-3">
                                <i class="fas fa-box-open"></i>
                                Destinos de Producción
                            </h1>
                            <p class="text-white/80 mt-1 text-sm">Control de Destinos para Material Retenido - Producción</p>
                        </div>
                    </div>
            ...
            <div class="modern-card overflow-hidden">
                <div class="p-5 modal-header">
                    <h3 class="text-lg font-bold text-white flex items-center">
                        <i class="fas fa-list-alt mr-3"></i>Listado de Destinos - Producción
                    </h3>
                ...
                <?php if (empty($data['destinos'] ?? [])): ?>
                    <div class="text-center py-12 text-gray-500 fade-in">
                        ...
                        <p class="text-xl">No hay destinos de producción registrados</p>
                    </div>
                <?php else: ?>
                    <?php
