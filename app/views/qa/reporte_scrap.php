...
<?php
/**
 * Vista de Reporte de Scrap: muestra las entregas de scrap validadas
...
<head>
    ...
    <meta name="description" content="Sistema de Control de Calidad - Reporte de Scrap">
    <title>Reporte de Scrap - QA</title>
    ...
    <link rel="stylesheet" href="/timeControl/public/assets/css/qa/reporte_scrap.css">
</head>
<body>
    ...
    <main class="lg:ml-72 p-4 md:p-6 min-h-screen">
                    ...
                    <div class="logo-container">
                        ...
                        <div>
                            <h1 class="text-2xl md:text-3xl font-bold text-white flex items-center gap-3">
                                <i class="fas fa-trash-alt"></i> Reporte de Scrap
                            </h1>
                            <p class="text-white/80 mt-1 text-sm">Sistema de Control de Calidad - Scrap</p>
                        </div>
                    </div>
        ...
        <div class="container mx-auto px-4 md:px-6 pb-8 max-w-7xl">
            ...
            <div class="stat-card mb-6 fade-in">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold" style="color: var(--red-primary);">
            ...
            <!-- Filtros -->
            <form method="get" class="modern-card p-4 mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" id="filtrosScrap">
                <div>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="/timeControl/public/reporte_scrap" class="btn-modern btn-secondary flex-1 justify-center">
                        <i class="fas fa-times mr-2"></i> Limpiar
                    </a>
                </div>
            </form>

            <!-- Contenido agrupado por máquina -->
            <div class="space-y-6">
                <?php
                    ...
                    <div class="modern-card text-center p-12 fade-in">
                        <div class="text-center" style="color: var(--red-primary);">
                            ...
                            <p class="text-gray-500 text-center max-w-md mt-2">
                                No hay entregas de scrap registradas.
                            </p>
                        </div>
                    </div>
                <?php else: ?>
                    <?php foreach ($agrupadas as $maquina => $entregasMaquina): ?>
                        <div class="machine-section p-6 mb-8 fade-in">
                            <h2 class="text-xl font-bold mb-6 flex items-center gap-2">
                                <i class="fas fa-cogs" style="color: var(--red-primary);"></i>
                                Máquina: <span style="color: var(--red-dark);"><?= htmlspecialchars($maquina) ?></span>
                            </h2>
                                ...
                                <?php foreach ($entregasMaquina as $entrega): ?>
                                    <div class="entry-card p-6 relative fade-in">
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <div class="entry-field md:flex items-center gap-3">
                                                <span class="entry-field-label md:inline hidden">Cantidad Scrap:</span>
                                                <div class="flex items-center gap-2">
                                                    <i class="fas fa-trash-alt" style="color: var(--red-primary);"></i>
                                                    <span class="entry-field-value font-extrabold text-lg" style="color: var(--red-dark);"><?= number_format($entrega['cantidad'], 2, '.', ',') ?> lb.</span>
                                                </div>
                                            </div>
                                            <?php if (!empty($entrega['observaciones'])): ?>
                                                <div class="entry-field md:flex items-start gap-3">
                                                    <span class="entry-field-label md:inline hidden">Observaciones:</span>
                                                    <div class="flex items-start gap-2">
                                                        <i class="fas fa-comment-alt text-gray-400 mt-1"></i>
                                                        <p class="entry-field-value text-sm text-gray-700"><?= htmlspecialchars($entrega['observaciones']) ?></p>
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="flex justify-center mt-4">
                                            <a href="/timeControl/public/reporte_scrap/detalle/<?= $entrega['id'] ?>" class="btn-modern btn-primary uppercase tracking-wider justify-center">
            ...
            <footer class="mt-8 text-center text-gray-500 text-xs py-6">
                <p>© <?= date('Y') ?> Reporte de Scrap - Todos los derechos reservados</p>
