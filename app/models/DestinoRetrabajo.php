...
class DestinoRetrabajo extends Model
{
    public function getDestinosRetrabajo($areaId = null, $userId = null)
    {
        try {
            $query = "
                SELECT 
                ...
                WHERE rd.tipo_destino = 'retrabajo'
            ...
            // Preparar los parametros de manera dinamica
            $types = '';
            $params = [];
            ...
            Logger::info('Consulta de destinos retrabajo', [
                'area_id' => $areaId,
                'usuario_id' => $userId,
            ...
            Logger::error('Error al obtener destinos retrabajo', [
                'error' => $e->getMessage(),
                'area_id' => $areaId,
                'usuario_id' => $userId
            ]);
