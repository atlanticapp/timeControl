...
class DestinoProd extends Model
{
    public function getDestinosProduccion($areaId = null, $userId = null)
    {
        try {
            $query = "
                SELECT 
            ...
            Logger::info('Consulta de destinos producción', [
                'area_id' => $areaId,
                'usuario_id' => $userId,
            ...
            Logger::error('Error al obtener destinos producción', [
                'error' => $e->getMessage(),
                'area_id' => $areaId,
                'usuario_id' => $userId
            ]);
